...
第一部では、パッケージマネージャー Nix の全体像と、導入によって得られる具体的なメリットについて紹介します。

また、Nix と既存のパッケージマネージャー（Homebrew や mise）をどう使い分けるのか？といったよくある疑問に対して、私の所感を提示します。

その後、実際に Nix をインストールし、パッケージの検索・更新といった基本的な操作を解説します。


# 目次

[1. Nix とは](https://zenn.dev/trifolium/books/1c0373f3570334/viewer/common-02)
