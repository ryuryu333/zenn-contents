...
topics: [nix, home-manager, git, dotfiles]
published: true
...
各パラメータを調べる 2 つの方法を解説します。

## 1 公式マニュアルで検索する
`home.nix` で利用する各パラメータの詳細は**マニュアルに記載されています**。

以下のページにて `programs.git.` で検索すると、いくつかヒットします。

https://nix-community.github.io/home-manager/options.xhtml#opt-programs.git.enable

ただ、これだと `programs.git` に用意されているパラメータを網羅的に見るのは大変です。

## 2 git.nix ファイルを読み解く
マニュアルにて `programs.git.enable` を確認すると、下側に `Declared by: <home-manager/modules/programs/git.nix>` というリンクがあります。

ここから nix ファイルを見ると、**各パラメータを網羅的に確認しやすい**です。
...
**一方、方法2は home-manager が提供している手法ですので、home-manager のマニュアルを調べる必要があります**。

https://nix-community.github.io/home-manager/options.xhtml#opt-programs.vim.enable

![home-manager マニュアルで vim を検索した結果](/images/642043cbae5f21/642043cbae5f21-2025-8-6_1.webp)
